...
top.LDAPI = (function() {
    ...
    GetValue = function (key) {
        ...
        if (key === 'launcher.url') {
            ...
            return url + '&returnURL=' + encodeURIComponent(top.baseUrl + '/return.html?cmid=' + top.cmid + '&CID=' + top.content_id + '&' + returnCmd) + '&cancelURL=' + encodeURIComponent(top.baseUrl + '/return.html?cmid=' + top.cmid + '&CID=' + top.content_id + '&' + cancelCmd) + '&userName=' + encodeURIComponent(top.userName);
        }
        return _data[key];
    }
