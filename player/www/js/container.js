...
var Container = (function() {
    ...
    Container.prototype = {
        ...
        loadContent: function() {
            ...
            targetDocument.location.href = top.baseUrl + '/contents/' + encodeURIComponent(top.content_id) + '/' + top.contentUrl;
        },
        ...
        unloadContent: function() {
            ...
            targetDocument.location.replace(top.baseUrl + '/blank.html');
        },
        ...
        exitContent: function() {
            top.location.href = top.baseUrl + '/menu.php?cid=' + encodeURIComponent(top.content_id);
        },
         ...
         */
        moveTo: function(id) {
            top.location.href = top.baseUrl + '/container.php?cid=' + encodeURIComponent(top.content_id) + '&NextID=' + encodeURIComponent(id);
        },
